...
# Response containing batch operation results for labeled object pair associations.
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of successfully processed labeled associations between object pairs.
...
# Represents a default association between two objects with specification.
...
public type BatchResponsePublicDefaultAssociation record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of default association results returned from the batch operation.
...
# Container for batch association fetch requests.
...
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of association results with labels returned from the batch operation.
...
# Response for batch operations that do not return data, only status information.
...
# Request object for fetching associations for a specific record.
